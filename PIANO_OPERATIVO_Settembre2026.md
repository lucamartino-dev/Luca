...
**Skylabs**
- **Chiudi Sidea (ott'26)** e insedia i **leader delle acquisizioni** nella panchina.
- **Completa il Partner Program** (interni + 4 Senior Partner esterni) **entro il 31/12/26**, con retention lock (vesting + lock-up al change of control).
- **Numeri audit-ready + info memo**; apri il **processo competitivo** (Cegeka + Bip + 1-2 alternativi) via advisor.
...
- **5 paletti sulla panchina:** (1) selezione non nomina — finestra di prova prima di dare ruoli chiave; (2) squadra, non un uomo solo; (3) àncora la continuità sul deal **certo (Sidea)**, non su quello incerto (Lobra, "forse"); (4) valuta che i profili scalino al livello gruppo; (5) legittimità/equity/mandato chiari + tuo sponsorship.
...
### L'esperienza di Skylabs come motore di Venere (senza legare le due aziende)

La "macchina centrale" di Venere (il platform-team alla Bending Spoons) di fatto **è** un *operating system* interno AI-driven: agenti che gestiscono agende, recall, pricing, procurement, KPI, decision-support clinico. È naturale chiedersi se travasarci lo **Skylabs OS**. **La linea è netta: le due aziende restano separate — di Skylabs porti in Venere l'esperienza, non l'asset.**

- **Nessun legame tra le due società.** Niente riuso del codice/IP di Skylabs, niente accordo commerciale, niente Venere-come-vetrina di Skylabs. Stai **vendendo** Skylabs a uno strategico (Cegeka/Bip): quell'IP sarà del compratore, e ogni intreccio riaccende il rischio già a tabella (*"Rivendica su IP del gestionale → separazione IP clean-room o licenza periziata"*) e **complica/abbassa la vendita**. Skylabs e Venere non si toccano.
- **Ciò che si trasferisce è l'esperienza, e cammina con le persone.** Il valore vero non è il software — è il **know-how tuo + di Diana**: come si costruisce e si fa girare una piattaforma agentica in verticale, cosa funziona e cosa no, gli errori già pagati, il metodo. Quello è **legittimamente vostro** e non ha vincoli: lo riversate in Venere costruendo il suo OS **da zero e in pulito**.
- **Il punto AI-driven:** l'"OS" di Venere non è un gestionale con sopra un chatbot. È l'azienda **progettata attorno agli agenti**: HQ minimo perché la piattaforma fa il coordinamento che altrove richiede middle-management. È qui che il DNA AI (commodity in Skylabs) diventa **vantaggio scarso** in un settore che non lo sa fare — ed è esperienza, non codice, a darvi il vantaggio di partenza.

**Verdetto:** sì a costruire un "Venere OS" al centro dell'azienda, **alimentato dall'esperienza Skylabs** — ma come sistema nuovo e indipendente. Le due aziende restano separate: nessun ponte tecnico o commerciale che possa intaccare la vendita di Skylabs.
