...
- La *vision* "global reference for AI" ha un **tetto teorico più alto** — **ma appartiene a una software company, non al roll-up di ore del deck** (Product ~2% dei ricavi; licenze reseller). Se il prodotto fosse il vero sogno, la mossa è mettere tutto su Universe, non comprare 3 consulenze.
...
| **MBO (ai soci/management)** | Founder-friendly, gli insider sono felici che tu esca, tieni minoranza | Servono compratori interni che *restino* + finanziamento (EBITDA sottile); prezzo più basso | Almeno un socio (Diana) vuole guidare/comprare Skylabs |
| **Build-to-sell (Diana-led)** | Exit più grande via roll-up, sfrutta la pipeline | Diana deve restare + anni + ti diluisci | Diana vuole guidarla + round SAE raccoglibili senza te |
...
- *La mia lettura:* se vai su Venere **e i soci ti seguono** (incluso Diana), l'opzione coerente è la **vendita piena a strategico**; l'MBO e il build-to-sell hanno senso solo se qualcuno resta a guidarla.
...
- *Candidati concreti:* **Cegeka Italia** (gruppo IT belga familiare, capitale paziente, fit strategico) e **Bip** (PE-backed CVC, logica piattaforma/multiplo, ama una pipeline pronta). Falli **competere** in un processo (+ 1-2 alternativi: Reply, Lutech, Engineering, NTT Data, Accenture).
...
| Luca | Diana (Salvo) | Cammalleri (Marcello) | COO |
|---|---|---|---|
| **55%** | **18%** | **15%** | **12%** |

(Diana sopra Cammalleri: operatore esperto e #2 provato vs credibilità clinica ma non uomo d'azienda.)

*Post raise (€12M per il 60%, pool creato al round):* investitori 60%; Luca ~15%, Diana ~5%, Cammalleri ~4%, COO ~3%, pool ~12-13%. Leve: **ratchet** (founder verso 45-50%+ a buon exit), **cash co-invest** (aumenta la tua %), **reverse vesting** su tutti; sedi di Cammalleri valutate separatamente (related-party).
...
| Diana in Venere | Sì, come **#2 ~18%** (sopra Cammalleri ~15%), con vesting |
